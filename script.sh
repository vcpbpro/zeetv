...
cp -f /home/__init__.py /home/vcpbx/config/__init__.py
mv /home/Telegram /home/vcpbx/Telegram #Move Telegram to VCPB's Home (make changes according to username)
